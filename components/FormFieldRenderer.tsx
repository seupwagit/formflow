...
interface FormFieldRendererProps {
  ...
  mode?: 'edit' | 'canvas' // 🆕 Modo de exibição (canvas não mostra placeholder vazio)
}
...
export default function FormFieldRenderer({ 
  ...
  const renderInput = () => {
    ...
    // 🆕 Placeholder: só mostra se estiver definido
    const getPlaceholder = () => {
      // Se tem placeholder definido, usa ele
      // Se não tem, retorna vazio (não gera texto automático)
      return field.placeholder || ''
    }
    
    // 🆕 Tooltip com dica (helpText)
    const getTitle = () => {
